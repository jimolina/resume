<div id="aboutme" class="page">
	...
	<div class="col-sm-12 col-md-6 content">
		...
		<h4 class="mt-5">
			Hello, I am <strong>Jose Molina</strong>, <strong>Freelance</strong> Web Developer, Photographer and Filmmaker.
		</h4>
		<p class="description">
			I have 20+ years of experience designing, structuring, developing, integrating, implementing and supporting interactive website. This includes work performed on Intranets, public websites, content management, database architecture and ecommerce.
		</p>
