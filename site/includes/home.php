<div id="home" class="page">
	...
	<p class="bubble first">
		<a class="btn btn-sm white scrollitem d-flex justify-content-around" href="#contactme">
  			<i class="fa fa-envelope-o fa-2x pull-left"></i>
			<span><small>I'm available for</small><br>FREELANCE</span>
		</a>
	</p>
	<p class="bubble second">
		<a class="btn btn-sm white d-flex justify-content-around" href="<?php echo $routeUploads; ?>jose_molina_resume.pdf" target="_Blank">
  			<i class="fa fa-cloud-download fa-2x pull-left"></i>
			<span><small>My Resume</small><br>DOWNLOAD</span>
		</a>
	</p>
</div>